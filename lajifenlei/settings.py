"""
Django settings for lajifenlei project.
...
SECRET_KEY = 'j*h=kp^ak7r)+(!+e()w=7+mh5as3l-)i!2w2pehsl7t80es6='
...
WSGI_APPLICATION = 'lajifenlei.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'pydb'),
    }
}
